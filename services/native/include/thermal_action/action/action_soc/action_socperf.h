...
#ifndef ACTION_SOCPERF_H
#define ACTION_SOCPERF_H

#include "soc_action_base.h"

namespace OHOS {
namespace PowerMgr {
class ActionSocPerf : public IThermalAction, public SocActionBase {
public:
    ActionSocPerf(const std::string& actionName);
    ~ActionSocPerf() = default;
