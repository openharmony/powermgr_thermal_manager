...
{
    THERMAL_HILOGI(LABEL_TEST, "ThermalServiceDeathTest_001 function start!");
    ...
    THERMAL_HILOGI(LABEL_TEST, "ThermalServiceDeathTest_001 function end!");
}
...
{
    THERMAL_HILOGI(LABEL_TEST, "ThermalServiceDeathTest_002 function start!");
    auto& thermalClient = ThermalMgrClient::GetInstance();
    EXPECT_EQ(thermalClient.Connect(), ERR_OK);
    ...
    EXPECT_NE(thermalClient.thermalSrv_, nullptr);
    THERMAL_HILOGI(LABEL_TEST, "ThermalServiceDeathTest_002 function end!");
}
}