...
#ifndef ACTION_CPU_NONVIP_H
#define ACTION_CPU_NONVIP_H

#include "soc_action_base.h"

namespace OHOS {
namespace PowerMgr {
class ActionCpuNonVip : public IThermalAction, public SocActionBase {
public:
    ActionCpuNonVip(const std::string& actionName);
    ~ActionCpuNonVip() = default;
