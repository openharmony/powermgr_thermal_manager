...
public:
    ...
    static int32_t SetCondition(int32_t value, const std::string& scene, int32_t charge, int32_t screen);
    static void SetScreenState(const std::string& scene);
    ...
    static int32_t GetStateMap(std::map<std::string, std::string>& stateMap);
