...
namespace PowerMgr {
    // action name
    const std::string AIRPLANE_ACTION_NAME = "airplane";
    ...
    const std::string SOCPERF_RESOURCE_ACTION_NAME = "socperf_resource";
    ...
    const std::string STATE_CUST = "cust";
    ...
    constexpr int32_t LIM_CPU_BIG2_ID = 1102;
    constexpr int32_t LIM_CPU_BIG3_ID = 1104;
    constexpr int32_t LIM_CPU_BIG4_ID = 1106;
