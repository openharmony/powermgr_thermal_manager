...
#ifndef THERMAL_LEVEL_CALLBACK_TEST_H
#define THERMAL_LEVEL_CALLBACK_TEST_H
...
namespace OHOS {
namespace PowerMgr {
class ThermalLevelCallbackTest : public testing::Test {
public:
...
#endif // THERMAL_LEVEL_CALLBACK_TEST_H