...
{
    THERMAL_HILOGI(LABEL_TEST, "ThermalClientMockParcelTest001 function start!");
    ...
    THERMAL_HILOGI(LABEL_TEST, "ThermalClientMockParcelTest001 function end!");
}
...
{
    THERMAL_HILOGI(LABEL_TEST, "ThermalClientMockParcelTest002 function start!");
    ...
    THERMAL_HILOGI(LABEL_TEST, "ThermalClientMockParcelTest002 function end!");
}
...
{
    THERMAL_HILOGI(LABEL_TEST, "ThermalMockProxyWriteremoteobjectTest001 function start!");
    std::string result = "a";
    sptr<MockThermalRemoteObject> sptrRemoteObj = new MockThermalRemoteObject();
    EXPECT_FALSE(sptrRemoteObj == nullptr);
